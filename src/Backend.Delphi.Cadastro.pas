...
type
  ...
  private
    procedure SetPagination(const AQuery: TFDQuery; const AQueryParams: TDictionary<String, String>);
    procedure SetOrdenacao(const AQuery: TFDQuery; const AQueryParams: TDictionary<String, String>);
  protected
    function GetQueryPesquisa: TArray<TFDQuery>;
  public
...
function TBackendDelphiCadastro.GetQueryPesquisa: TArray<TFDQuery>;
begin
...
procedure TBackendDelphiCadastro.SetPagination(const AQuery: TFDQuery; const AQueryParams: TDictionary<String, String>);
begin
